...
for f in eval_stud8.py eval_razz.py pbs.py bucket.py train.py net_leaf.py resolve.py \
         razz_game.py bucket_razz.py bucket_resolve_razz.py datagen_razz.py \
         datagen.py bucket_resolve.py datagen_bucketed.py \
